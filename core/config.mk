...
ifneq ($(HEKA_BUILD),)
include vendor/heka/config/BoardConfigHeka.mk
endif
...
ifneq ($(HEKA_BUILD),)
ifneq ($(wildcard device/heka/sepolicy/common/sepolicy.mk),)
## We need to be sure the global selinux policies are included
## last, to avoid accidental resetting by device configs
$(eval include device/heka/sepolicy/common/sepolicy.mk)
endif
endif
